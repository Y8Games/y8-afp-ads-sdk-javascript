...
// Define variables
		...
		this.interstitalBtn = document.getElementById('interstitalButton');
		this.rewardBtn = document.getElementById('rewardAdButton');
...
// On click listeners for the game's buttons.
		...
		this.interstitalBtn.addEventListener('click', () => {            
            nextAds();
        });
...
// Start the game
    play() {
        console.log("play")
        console.log("shouldShowAdOnPlay1"+this.shouldShowAdOnPlay)
